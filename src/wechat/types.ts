...
export interface GetUploadUrlReq {
  ...
  media_type?: EnumValues<typeof UploadMediaType>
  to_user_id?: string
  /** 原文件明文大小 */
  rawsize?: number
  /** 原文件明文 MD5 */
...
export interface IMessageItem<
  T extends EnumValues<typeof MessageItemType> = EnumValues<
    typeof MessageItemType
  >,
> {
  type?: T
...
export interface SendTypingReq {
  ...
  status?: EnumValues<typeof TypingStatus>
}
